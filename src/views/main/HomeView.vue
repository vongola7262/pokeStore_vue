<template>
    ...
    <div class="centerBox">
      <div class="titleBox">
        <div class="mainBox">
          ...
          <h1>這裡是寶可夢中心</h1>
          <p>
            停下腳步休息喝口水，讓寶可夢吃點零食，<br />補充冒險所需的物資，精靈球、藥水一切應有盡有，<br />與朋友、家人們一同踏上充滿刺激與歡樂的旅程。
          </p>
        </div>
      </div>
    </div>
    <div class="morePageBtn"></div>
  </section>
    ...
    <div class="container">
      ...
      >
        <div
          ...
          :key="index"
        >
          <a href="#" class="productType" @click.prevent="goType(item.link)">
            <div class="iconBox">
              <div class="iconBox2">
                <div class="iconBox3">
  ...
  <section class="productSwiper">
    <ProductSwiper :swiperHot="swiperHot" :swiperJoint="swiperJoint"></ProductSwiper>
  </section>
  <section class="learnMore">
    <div class="centerBox">
      ...
      >
        <h2>不只是寶可夢 ?</h2>
        <p>
          隨著Pokemon Go的推出，全球再次迎來全新的寶可夢浪潮。
          <br />由於遊戲設定促使了玩家走出家門，到當地各個社區地標、公園、歷史建築踩點。
          <br />許多冷門地點都開始熱鬧了起來，也讓過往不怎麼關心社區身邊事物的民眾，重新認識自己居住的區域。
          <br />
          <br />我們希望由這份契機，讓民眾更加親近自己的生活環境，踏出戶外，漸漸而走入大自然的懷抱，
          <br />增加家人朋友間的互動與歡懷，因此不定時會推出家庭購物優惠，與多人同樂優惠，
          <br />遊玩的同時也不忘親近大自然。
        </p>
      </div>
      <div
      ...
      >
        ...
        <a href="#" class="useCode" @click.prevent="goType('/typeList/all')">
          <h4>使用優惠碼</h4>
        </a>
      </div>
    </div>
...
section.homePage
  ...
  .morePageBtn
    ...
    bottom: 8%
    animation: learn-more 3s infinite
